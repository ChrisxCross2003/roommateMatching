...
public class StableMatching {
    ...
    private final List<Student> totalOddMenOut = new ArrayList<>();
    ...
    public void matchStudents() {
        ...
        Export.exportGroupsToJson(allGroups, totalOddMenOut, "matches_8b5f1a2d7a9c3f1e3d0.json");
    }
    ...
    static boolean isPhantomStudent(Student s) {
